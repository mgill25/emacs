...
(add-hook 'js2-mode-hook (lambda ()
                           (flycheck-mode t)
                           (cond ((string-match "\\.js\\'" buffer-file-name)
                                  (setq flycheck-jshintrc "~/.jshintrc"))
                                 ((string-match "\\.es\\'" buffer-file-name)

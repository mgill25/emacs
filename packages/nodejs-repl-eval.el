;;; Taken from https://atlanis.net/blog/posts/nodejs-repl-eval.html
...
(defun nodejs-repl-start-and-eval-region (start end)
  "Send region to `nodejs-repl' process. Stars a new process if one doesn't already exist"
  (interactive "r")
